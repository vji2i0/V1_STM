                ...
                case 1: {
                    ...
                    */
                    ...
                    if (recognize_flag & 0b00000100){
                        ...
                        */
                        placement.z = z;
                        //if (z == 10) {HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_15);}
                    }else{
                    ...
                    moveOn(f);
                    //sendStaicMessage(buffer); для дебага
                    //HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_15);
                    break;
                }
                case 92: {
    ...
    */
    ...
    if (recognize_flag & 0b10000000)
    {
        ...
        */
        if (G == 1)
        {
            if (recognize_flag & 0b00010000) nextXtranslation = (x - location.x)*STEPS_PER_X - currentXtranslation;
            if (recognize_flag & 0b00001000) nextYtranslation = (y - location.y)*STEPS_PER_Y - currentYtranslation;
        }
    }
}
    ...
    */
    ...
    if (recognize_flag & 0b10000000)
    {
        ...
        */
        if (G == 1)
        {
            if (recognize_flag & 0b00010000) currentXtranslation = (x - location.x)*STEPS_PER_X;
            if (recognize_flag & 0b00001000) currentYtranslation = (y - location.y)*STEPS_PER_Y;
        }
    }
}
